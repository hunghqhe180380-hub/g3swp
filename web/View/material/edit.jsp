    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
            ...
            <body>
                ...
                <c:set var="hasExistingFile" value="${not empty material.fileUrl}" />
                ...
                <div class="matc-header">
                    <div class="container d-flex align-items-center justify-content-between">
                        <div class="py-3">
                            ...
                            <h4 class="mb-0">Edit material &bull; ${className}</h4>
                        </div>
                ...
                <div class="container py-3 section-shell">
                    <div class="card shadow-sm border-0">
                        <div class="card-body p-4">
                            ...
                            <form action="${pageContext.request.contextPath}/material/manage/edit" method="post"
                                enctype="multipart/form-data" id="materialForm">

                                <!-- Hidden fields -->
                                <input type="hidden" name="id" value="${material.id}">
                                <input type="hidden" name="classId" value="${material.classId}">
                                <!-- flag read by JS to track existing file -->
                                <input type="hidden" id="hasExistingFile" value="${hasExistingFile}">
                                ...
                                <div class="row g-3">
                                    <div class="col-12 col-lg-7">
                                        ...
                                        <input name="title" class="form-control form-control-lg" id="titleInput"
                                            placeholder="Short, clear title…" value="${fn:escapeXml(material.title)}"
                                            maxlength="200">
                                    </div>
                                    <div class="col-12 col-lg-5">
                                        <label class="form-label fw-semibold">Description</label>
                                        <input name="description" class="form-control" placeholder="Optional summary…"
                                ...
                                <div class="row g-4">
                                        ...
                                        <div class="matc-box">
                                            <div class="matc-box__head">
                                                <div class="matc-box__title">
                                                    <span class="pill pill-indigo"><i class="bi bi-play-btn"></i> Video
                                                        / Link</span>
                                                </div>
                                            </div>
                                            <div class="matc-box__body">
                                                ...
                                                <div id="urlPreview" class="mt-3 d-none">
                                                    <div class="ratio ratio-16x9">
                                                        <iframe id="ytFrame" title="Preview" allowfullscreen
                                                            loading="lazy"></iframe>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="matc-box">
                                            <div class="matc-box__head">
                                                <div class="matc-box__title">
                                                    <span class="pill pill-emerald"><i class="bi bi-paperclip"></i>
                                                        File</span>
                                                </div>
                                            </div>
                                            <div class="matc-box__body">
                                                <!-- Existing file info (if any) -->
                                                <c:if test="${hasExistingFile}">
                                                    <div
                                                        class="alert alert-light border d-flex align-items-center justify-content-between mb-3">
                                                        <div class="text-truncate me-2">
                                                            <i class="bi bi-file-earmark"></i>
                                                            <a href="${pageContext.request.contextPath}${material.fileUrl}"
                                                                target="_blank">
                                                                <c:choose>
                                                                    <c:when
                                                                        test="${not empty material.originalFileName}">
                                                                        ${material.originalFileName}</c:when>
                                                                    <c:otherwise>Current File</c:otherwise>
                                                                </c:choose>
                                                            </a>
                                                        </div>
                                                        <div class="form-check m-0 flex-shrink-0">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="removeFile" name="removeFile" value="true">
                                                            <label class="form-check-label small"
                                                                for="removeFile">Remove</label>
                                                        </div>
                                                    </div>
                                                </c:if>
                                                ...
                                                <div id="dropZone" class="matc-drop">
                                                    ...
                                                    <div class="matc-drop__icon"><i class="bi bi-cloud-arrow-up"></i>
                                                    </div>
                                                    <div class="matc-drop__text">
                                                        <strong>Drag &amp; drop</strong> or
                                                        <button type="button" class="btn btn-soft-slate btn-sm ms-1"
                                                            id="browseBtn">Browse</button>
                                                    </div>
                                                </div>
                                                <div id="fileInfo"
                                                    class="alert alert-light border d-none mt-3 mb-0 small">
                                                    <i class="bi bi-file-earmark"></i>
                                    ...
                                    <div class="col-12">
                                        <div class="matc-box">
                                            <div class="matc-box__head">
                                                <div class="matc-box__title">
                                                    <span class="pill pill-sky"><i class="bi bi-list-task"></i> Text /
                                                        Index</span>
                                                </div>
                                            </div>
                                            <div class="matc-box__body">
                                                ...
                                                <textarea name="indexContent" class="form-control" rows="8"
                                                    id="indexInput"
                                                    placeholder="Write something helpful…">${fn:escapeXml(material.indexContent)}</textarea>
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-4">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="submit" id="btnSave" class="btn btn-grad-amber px-4">Save
                                            Changes</button>
                                    </div>
                                </div>
                            </form>
